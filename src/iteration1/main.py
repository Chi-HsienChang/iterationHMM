...
fasta_file_path = '../../dataset/iteration1/train/L2_i1.fasta' # salima
...
with open("../../hmm/iteration1/L2_i1.hmm", "wb") as output_file: 
...
fasta_file_path = '../../dataset/iteration1/train/L3_i1.fasta' # salima
...
with open("../../hmm/iteration1/L3_i1.hmm", "wb") as output_file: 
...
# Path to the FASTA file for L3 sequence training (Salima's dataset)
fasta_file_path = '../../dataset/iteration1/train/All_i1.fasta' # salima
...
with open("../../hmm/iteration1/All_i1.hmm", "wb") as output_file: 
...
"""
with pyhmmer.plan7.HMMFile("../../hmm/iteration1/L2_i1.hmm") as hmm_file:
    hmm_L2 = next(hmm_file)
with pyhmmer.plan7.HMMFile("../../hmm/iteration1/L3_i1.hmm") as hmm_file:
    hmm_L3 = next(hmm_file)


# 創建字母表
alphabet = pyhmmer.easel.Alphabet.amino()
fasta_file_path = '../../dataset/iteration1/test/interpro_structured_disordered.fasta' # salima
...
NA_name = []
# 打開一個 CSV 文件以寫入數據
with open('../../result/iteration1/i1_interpro_L7.csv', 'w', newline='') as csvfile:
...
file_path = '../../result/iteration1/i1_NA_names.txt'
...
# 定义CSV文件路径
files = ['../../result/iteration1/i1_interpro_L7.csv']
...
for file, label in tqdm(zip(files, labels), "Plot"):
    ...
    plt.savefig(f'../../result/iteration1/i1_csv.png')
