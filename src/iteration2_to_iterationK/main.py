...
def plot_combined_clade_frequencies(l2_df, l3_df, iteration, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join("../../result/iteration2_to_iterationK/clade_frequency", f'combined_clade_frequency_iteration_{iteration}.png'))
    plt.close()
############################################################################################
...
def main_pipeline(thresholds_file, real_file, decoy_files, iterations=30, csv_dir = '../../dataset/iteration2_to_iterationK/input_csv', output_dir='./result_test', hmm_dir='../../hmm/iteration2_to_iterationK/', representative='./result_test/representative/'):
    ...
    for iteration in range(1,iterations+1):
        ...
        real_file = [f'../../dataset/iteration2_to_iterationK/input_csv/i{iteration}/aligned_real.fasta.csv']
        ...
        # 讀取並處理每個文件
        # 读取 CSV 文件
        file_path = f'../../dataset/iteration2_to_iterationK/input_csv/i{iteration}/aligned_real.fasta.csv'  # 需要替换 {iteration} 为实际迭代数
        ...
        plt.grid(True)
        plt.savefig(f"../../result/iteration2_to_iterationK/i{iteration}.png")
        plt.close()
...
thresholds_file = ['../../dataset/iteration2_to_iterationK/input_csv/i1/all_L7_decoy.csv']
real_file = ['../../dataset/iteration2_to_iterationK/input_csv/i1/aligned_real.csv']
decoy_files = ['../../dataset/iteration2_to_iterationK/input_csv/i1/all_L7_decoy.csv', '../../dataset/iteration2_to_iterationK/input_csv/i1/L2_decoy.csv', '../../dataset/iteration2_to_iterationK/input_csv/i1/L3_decoy.csv']
