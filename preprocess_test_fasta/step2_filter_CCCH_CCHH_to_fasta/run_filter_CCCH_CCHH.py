...
for fasta in fasta_sequences:
    ...
    new_description = fasta.description + f"|{cleaned_seq[34]}{cleaned_seq[42]}{cleaned_seq[57]}{cleaned_seq[61]}{cleaned_seq[-33]}{cleaned_seq[-30]}{cleaned_seq[-14]}{cleaned_seq[-8]}"
